function [ MeanAccuracy, StdAccuracy ] = qssvm_confirm( set_biased, labelset, logC, times, k , fourline )
%qssvm_confirm 此处显示有关此函数的摘要
% function
% evaluate dagher qsvm using random selection from dataset

% args
% set_biased: n*m matrix which comprises unbalanced two-class susbets
% labelset: corresponding labelset
% logC: penalty efficient
% times: for repeating
